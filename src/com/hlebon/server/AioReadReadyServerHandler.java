...
public class AioReadReadyServerHandler implements CompletionHandler<Integer,ByteBuffer>
{
    private AsynchronousSocketChannel socket;
    private CharsetDecoder decoder = Charset.forName("UTF-8").newDecoder();
    private byte[] objectInByte;

    public AioReadReadyServerHandler(AsynchronousSocketChannel socket, byte[] objectInByte) {
